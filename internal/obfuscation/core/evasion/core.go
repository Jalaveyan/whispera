...
type CircuitBreaker struct {
	FailureCount    int           // Exported
	LastFailureTime time.Time     // Exported
	State           string        // Exported: "closed", "open", "half-open"
	Threshold       int           // Exported
...
// EvasionSystemMetrics tracks system performance and resilience
...
// EvasionEffectivenessMetrics tracks effectiveness metrics
...
// evaluateConditionFast provides lock-protected evaluation
